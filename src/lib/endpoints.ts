...
export const HALL_OF_FAME_CATEGORY = (category: string, page: number = 1) =>
  `${BACKEND_API}api/user/hall-of-fame/?category=${category}&page=${page}`

export const RECAP_CATEGORY = (category: string, page: number = 1) =>
  `${BACKEND_API}api/recap/?category=${category}&page=${page}`
...
export const GET_REVIEWS = (id: string, page = 1) =>
  `${BACKEND_API}api/listing/reviews/?listing=${id}&page=${page}`
